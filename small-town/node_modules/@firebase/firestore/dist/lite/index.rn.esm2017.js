 ...
 */ class qr {
    ...
    recordVersion(t) {
        ...
        if (n) {
            ...
            throw new j(x, "Document version changed between two reads.");
 ...
 */ class Ur {
    ...
    enqueue(t) {
        ...
        // advance the queue even when the operation is not run.
                const e = new k;
        return this.Mt((() => this.xt && this.Lt ? Promise.resolve() : (t().then(e.resolve, e.reject), 
...
}), "PUBLIC" /* PUBLIC */)), s("firestore-lite", "0.0.900-exp.6ef484a04", "node");

export { vn as Bytes, fn as CollectionReference, hn as DocumentReference, Yn as DocumentSnapshot, _n as FieldPath, bn as FieldValue, sn as FirebaseFirestore, j as FirestoreError, En as GeoPoint, ln as Query, tr as QueryConstraint, Kn as QueryDocumentSnapshot, Jn as QuerySnapshot, _t as Timestamp, jr as Transaction, Fr as WriteBatch, Pr as addDoc, Dr as arrayRemove, Nr as arrayUnion, dn as collection, wn as collectionGroup, cn as connectFirestoreEmulator, Ar as deleteDoc, Rr as deleteField, mn as doc, gn as documentId, wr as endAt, dr as endBefore, br as getDoc, Er as getDocs, un as getFirestore, $r as increment, on as initializeFirestore, ur as limit, cr as limitToLast, ir as orderBy, er as query, yn as queryEqual, pn as refEqual, kr as runTransaction, Vr as serverTimestamp, Tr as setDoc, m as setLogLevel, Zn as snapshotEqual, lr as startAfter, hr as startAt, an as terminate, Ir as updateDoc, rr as where, xr as writeBatch };
