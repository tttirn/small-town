 ...
 */ var qr = /** @class */ function() {
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.Mt((function() {
            return e.xt && e.Lt ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
