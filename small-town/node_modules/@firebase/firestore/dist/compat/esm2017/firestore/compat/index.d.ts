...
import { DocumentReference, CollectionReference, DocumentData, Query, EmulatorMockTokenOptions, PersistenceSettings, DocumentSnapshot, QuerySnapshot, FirebaseFirestore, Settings, LoadBundleTask, FirestoreError, Unsubscribe, SnapshotListenOptions, QueryConstraint, Transaction, SetOptions, UpdateData, FieldPath, WriteBatch } from "@firebase/firestore";
