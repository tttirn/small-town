...
var WindowMessagingFactory = function (container) {
    ...
    var messaging = new MessagingService(container.getProvider('app-exp').getImmediate(), container.getProvider('installations-exp-internal').getImmediate(), container.getProvider('analytics-internal'));
...
function registerMessagingInWindow() {
    app._registerComponent(new component.Component('messaging-exp', WindowMessagingFactory, "PUBLIC" /* PUBLIC */));
}
...
function getMessagingInWindow(app$1) {
    ...
    return app._getProvider(util.getModularInstance(app$1), 'messaging-exp').getImmediate();
}
/**
