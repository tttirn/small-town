...
const SwMessagingFactory = (container) => {
    ...
    const messaging = new MessagingService(container.getProvider('app-exp').getImmediate(), container.getProvider('installations-exp-internal').getImmediate(), container.getProvider('analytics-internal'));
...
function registerMessagingInSw() {
    _registerComponent(new Component('messaging-sw-exp', SwMessagingFactory, "PUBLIC" /* PUBLIC */));
}
...
function getMessagingInSw(app = getApp()) {
    return _getProvider(getModularInstance(app), 'messaging-sw-exp').getImmediate();
}
/**
...
export { getMessagingInSw as getMessaging, isSwSupported as isSupported, onBackgroundMessage };
